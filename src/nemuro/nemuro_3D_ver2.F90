...
!anju 02Aug2020*******************************************
use size_mod, only : month,imt,jmt,gdx,gdy
!************************************
...
real, allocatable, dimension(:,:,:,:) :: nit_read, sil_read
    ...
    do j = jsc, jec
      ...
      do k = 1, levs
        ...
        call nemuro(tr(i,j,k,2,1), tr(i,j,k,2,2), tr(i,j,k,2,3), &
                    ...
                    RnewL(i,j,k),tr_read(i,j,k,6,month),tr_read(i,j,k,10,month), & !10 -> SIOH, 6 -> NO3
